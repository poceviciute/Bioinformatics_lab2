...
We see that the original data set from GenBank contains a small amount of additional "nucleotides": they are called "y", "m", and "r". They are probably some measurement errors that were produced when the DNA sequence was scanned.
